...
build-image:
	cd server && DOCKER_DEFAULT_PLATFORM="linux/amd64" docker build -t ${AWS_ACCOUNT_ID}.dkr.ecr.us-west-2.amazonaws.com/messaging-system-app:1.0.0 .
...
push-image: build-image
	...
	docker push ${AWS_ACCOUNT_ID}.dkr.ecr.us-west-2.amazonaws.com/messaging-system-app:1.0.0
